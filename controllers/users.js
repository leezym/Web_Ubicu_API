...
module.exports = {
    ...
    updateUser: async(req, res) => {
        ...
        try {
            ...
            if (existingUser) {
                return res.status(400).send({ msg: 'La cédula ya está registrada en otro usuario. No se puede modificar.' });
            }
            ...
            res.status(500).send({ msg: "Ocurrió un error en el servidor. Por favor intente más tarde." });
        }
    },
    ...
    getUserbyId: async(req, res) => {
        ...
        try {
            ...
            res.sendStatus(500).json({ msg: "Ocurrió un error en el servidor. Por favor intente más tarde." });
        }
    },
    updatePassword: async (req, res) => {
        ...
        try {
          ...
          return res.status(500).send({ msg: 'Ocurrió un error en el servidor. Por favor intente más tarde..' });
        }
    },
